...
class JebuMaamCard extends StatelessWidget {
  const JebuMaamCard({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'jebunnahar@gmail.com' ' / ' '01761853080',
            textAlign: TextAlign.center,
            style: TextStyle(
      ...
      body: Container(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  'Director, IQAC at Shanto-Mariam University of Creative Technology'),
            ),
            Divider(),
            ListTile(
              title: Text('General Secratary at 71 Foundation'),
            ),
            Divider(),
            ListTile(
              title: Text('Studied at Vladimir State University, Russia'),
            ),
            Divider(),
          ],
        ),
