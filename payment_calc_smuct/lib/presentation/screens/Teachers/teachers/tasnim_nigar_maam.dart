...
class TasnimNigarMaamCard extends StatelessWidget {
  const TasnimNigarMaamCard({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'tasnim.tisha@gmail.com' ' / ' '01731222452',
            textAlign: TextAlign.center,
            style: TextStyle(
      ...
      body: Container(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  'Co-Ordinator (evening) ,CSE & CSIT at Shanto-Mariam University of Creative Technology'),
            ),
            Divider(),
            ListTile(
              title: Text('Studied at University of Dhaka.'),
            ),
            Divider(),
          ],
        ),
