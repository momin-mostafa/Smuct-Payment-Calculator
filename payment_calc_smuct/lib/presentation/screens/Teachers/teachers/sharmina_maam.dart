...
class SharminaMaamCard extends StatelessWidget {
  const SharminaMaamCard({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'sharminalima@gmail.com' ' / ' '01955529782',
            textAlign: TextAlign.center,
            style: TextStyle(
      ...
      body: Container(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  'Studied at Khulna University of Engineering & Technology: KUET'),
            ),
            Divider(),
          ],
        ),
